...
train_clean_100="/data/librispeech_data/train-clean-100/LibriSpeech/train-clean-100.csv"
train_clean_360="/data/librispeech_data/train-clean-360/LibriSpeech/train-clean-360.csv"
train_other_500="/data/librispeech_data/train-other-500/LibriSpeech/train-other-500.csv"
dev_clean="/data/librispeech_data/dev-clean/LibriSpeech/dev-clean.csv"
dev_other="/data/librispeech_data/dev-other/LibriSpeech/dev-other.csv"
test_clean="/data/librispeech_data/test-clean/LibriSpeech/test-clean.csv"
test_other="/data/librispeech_data/test-other/LibriSpeech/test-other.csv"

# Step 2: generate train dataset and evaluation dataset
echo "Data preprocessing..."
train_file="/data/librispeech_data/train_dataset.csv"
eval_file="/data/librispeech_data/eval_dataset.csv"
...
final_train_file="/data/librispeech_data/final_train_dataset.csv"
final_eval_file="/data/librispeech_data/final_eval_dataset.csv"
